...
class TcpListenProcessor {
   ...
   *
   * @name tcpListenProcessor.process
   * @function
   */
  process() {
    this._clear()
...
exports = module.exports = TcpListenProcessor
exports.operationSteps = 1
exports.operation = 'tcp:server listen'
