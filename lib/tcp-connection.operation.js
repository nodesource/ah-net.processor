...
class TcpConnectionOperation {
   ...
   *
   * @name tcpConnectionOperation._processTls
   * @function
   * @param {Object} info information about the tls aspect of the connection
   */
  _processTls(info) {
    this._tls = processTls(info)
    if (this._includeActivities) this._tls.activity = info.activity
  }
