...
const activities = new Map(require('../test/fixtures/http-one-connection.server.json'))
const processor = new HttpConnectionProcessor({ activities })
const { groups, operations } = processor.process()
